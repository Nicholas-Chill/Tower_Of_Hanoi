...
left_peg_hitbox = pygame.rect.Rect(lt_peg_hb_x, peg_hitbox_y, peg_hitbox_width, screen_height)
...
disk2_center = disk2_right_edge - disk2_width / 2
disk3_center = disk3_right_edge - disk3_width / 2
